...
For timelining the virus in a particular country, the FT article uses days since first confirmed case in that country. In that spirit, I'll use days since first confirmed death.
...
ggplot(
  ...
  labs(x = "days since first death", y = "deaths per million",
       colour = "deaths per million yesterday") +
