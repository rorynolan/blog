...
* **The Netherlands** and **France**'s curves are looking a lot like Italy's. They're running out of time to avoid ending up like Italy.
...
* **Belgium**'s reporting appears to be erratic, but from what I can tell, they look to be in a similar situation to the Netherlands but a bit worse.
...
* **Great Britain** looks to be faring better than Belgium and The Netherlands, but is showing exponential growth.
...
* **Germany**'s growth matches that of the USA.
...
* `r round(ca_days_since_tenth_death)` days after its tenth death, **California** is at approximately `r round(ca_current_deaths_per_million)` `r if_else(round(ca_current_deaths_per_million) == 1, "death", "deaths")` per million. This is similar to where Italy was at this stage, but California's curve is flatter than Italy's, so they may avoid the explosion in cases that happened there.
